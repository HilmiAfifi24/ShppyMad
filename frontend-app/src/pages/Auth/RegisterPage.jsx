...
export default function RegisterPage() {
    ...
    return (
        <div className="w-full h-screen flex flex-col">
            <header className="w-full flex justify-between items-center px-6 sm:px-10 md:px-28 py-4 border-b">
                <div className="text-orange-600 text-xl font-bold flex items-center">
                    <span className="text-2xl">🛍</span> Shopymad <span className="ml-2 text-gray-600">Register</span>
                </div>
                <a href="#" className="text-red-500 text-sm">Butuh bantuan?</a>
            </header>
            <div className="flex flex-col lg:flex-row flex-1">
                <div className="hidden md:flex w-full lg:w-1/2 bg-orange-500 text-white flex-col justify-center items-center p-10">
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-center p-6">
                    <div className="w-full max-w-sm sm:max-w-md bg-white shadow-lg rounded-lg p-6">
                        ...
                        <p className="text-center text-sm text-gray-600 mt-6">
                            Sudah punya akun? <Link to="/login" className="text-orange-500 font-semibold">Log in</Link>
                        </p>
                    </div>
                </div>
            </div>
